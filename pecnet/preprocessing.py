...
def rolling_op(data, window_size, op, fill=True, step=1):
    """
...
def prepare_and_split_data(input_data, window_size, split_index=None, step=1, fill=False, normalize=True, start=0, window_split_index=None):
    """
    Applies all of the preprocessing steps. 
    In Wavelet cA2 is discarded.
    This function is just a wrapper for the process of data preparation. If the process is different you need to write your own prepare_data.
...
def prepare_and_split_error_data(input_data, window_size, split_index=None, step=1, fill=False, normalize=True, start=0, window_split_index=None):
    """
    Applies all of the preprocessing steps. 
    In Wavelet cA2 is discarded.
    This function is just a wrapper for the process of data preparation. If the process is different you need to write your own prepare_data.
